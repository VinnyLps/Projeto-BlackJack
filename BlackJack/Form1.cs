...
namespace BlackJack
{
    public partial class Form_jogo : Form
    {
        ...
        public void resultado()
        {
            ...
            if ((pontos_A > pontos_B && pontos_A <= 21) | (pontos_A < pontos_B && pontos_B >=22))
                lbl_Resultado.Text = "Jogador 1 GANHOU!";
            else
                if ((pontos_A < pontos_B && pontos_B <= 21) | (pontos_A >= 22 && pontos_B < pontos_A))
        ...
        public void Jogada(PictureBox A, int jogador)
        {
            ...
            switch (x)
            {
                ...
                case 14:
                    if (jogador == 1)
                    {
                        A.Image = Properties.Resources.P; total_pontos -= (pontos_A - bonus); break;
                        pontos_A += total_pontos;
                    }
                    else
                    {
                        A.Image = Properties.Resources.P; total_pontos -= (pontos_B - bonus); break;
